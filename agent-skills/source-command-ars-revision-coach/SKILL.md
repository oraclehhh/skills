---
name: "source-command-ars-revision-coach"
description: "ARS academic-paper `revision-coach` mode — Revision Roadmap + Response Letter Skeleton"
---

# source-command-ars-revision-coach

Use this skill when the user asks to run the migrated source command `ars-revision-coach`.
